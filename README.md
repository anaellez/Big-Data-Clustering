...
2. Running the Pipeline: First, ensure your Kafka broker and Zookeeper (if required) are running. Then, start the data producer to stream the Spotify datasets into the topic:
